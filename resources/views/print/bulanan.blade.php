...
<div class="p-6">
  <h1 class="text-xl font-bold mb-4">Kehadiran Bulanan ({{ \Carbon\Carbon::parse($bulanIni)->translatedFormat('F Y') }})</h1>
    ...
    <tbody>
      @foreach ($data as $item)
        <tr>
          ...
          <td class="border px-4 py-2">{{ $item->anggota->nama ?? 'Tidak diketahui' }}</td>
